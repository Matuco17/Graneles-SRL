...
import com.orco.graneles.model.personal.ObraSocialFacade;
...
@ManagedBean(name = "obraSocialController")
@SessionScoped
public class ObraSocialController implements Serializable {

    private ObraSocial current;
    ...
    public ObraSocial getSelected() {
        if (current == null) {
            current = new ObraSocial();
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String prepareView() {
        current = (ObraSocial) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/BundlePersonal").getString("ObraSocialCreated"));
            return "View";
        } catch (Exception e) {
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/BundlePersonal").getString("ObraSocialUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/BundlePersonal").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/BundlePersonal").getString("ObraSocialDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/BundlePersonal").getString("PersistenceErrorOccured"));
        }
    }
