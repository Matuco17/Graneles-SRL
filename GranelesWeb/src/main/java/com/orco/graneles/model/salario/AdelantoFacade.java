...
public class AdelantoFacade extends AbstractFacade<Adelanto> {
    ...
    public BigDecimal calcularTotalAdelantoAcumulado(Personal personal, Date fechaReferencia){
        ...
        double acumulado = 0;
        acumulado += conceptoReciboF.calcularValorSAC(personal, fechaInicio, fechaFin, null, true, true, true, true);
        acumulado += conceptoReciboF.calcularValorVacaciones(personal, fechaInicio, fechaFin, null, true, true, true, true);
     ...
     * @return 
     */
    public List<Adelanto> obtenerAdelantosPeriodo(Personal personal, Date fechaReferencia){
        Date fechaInicio = periodoF.obtenerFechaInicioPeriodoSemestral(fechaReferencia);
        Date fechaFin = fechaReferencia;
